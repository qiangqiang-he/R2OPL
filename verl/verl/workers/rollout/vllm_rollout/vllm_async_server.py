...
class vLLMHttpServer:
    ...
    async def generate(
        ...
        engine_generate_s = time.perf_counter() - engine_started_at
        ...
        extra_fields = {"global_steps": self.global_steps, "engine_generate_s": engine_generate_s}
        logprob_extract_started_at = time.perf_counter()
        extract_prompt_logprobs(
            output=final_res,
